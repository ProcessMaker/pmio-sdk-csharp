...
namespace ProcessMaker.PMIO.Model
{
    ...
    public partial class Process :  IEquatable<Process>
    {
        ...
        public Process(string Id = null, string Type = null, ProcessAttributes Attributes = null)
        {
            // to ensure "Type" is required (not null)
            if (Type == null)
            {
                throw new InvalidDataException("Type is a required property for Process and cannot be null");
            }
            else
            {
                this.Type = Type;
        ...
        public ProcessAttributes Attributes { get; set; }
        /// <summary>
