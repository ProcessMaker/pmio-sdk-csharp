...
namespace ProcessMaker.PMIO.Model
{
    ...
    public partial class TaskInstance :  IEquatable<TaskInstance>
    {
        ...
        /// <param name="Type">Type (required) (default to &quot;task_instance&quot;).</param>
        /// <param name="Attributes">Attributes.</param>
        public TaskInstance(string Id = null, string Type = null, TaskInstanceAttributes Attributes = null)
        {
            // to ensure "Type" is required (not null)
            if (Type == null)
            {
                throw new InvalidDataException("Type is a required property for TaskInstance and cannot be null");
            }
            else
            {
                this.Type = Type;
        ...
        public TaskInstanceAttributes Attributes { get; set; }
        /// <summary>
