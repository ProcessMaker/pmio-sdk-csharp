...
namespace ProcessMaker.PMIO.Model
{
    ...
    public partial class Gateway :  IEquatable<Gateway>
    {
        ...
        /// <param name="Type">Type (required) (default to &quot;gateway&quot;).</param>
        /// <param name="Attributes">Attributes.</param>
        public Gateway(string Id = null, string Type = null, GatewayAttributes Attributes = null)
        {
            // to ensure "Type" is required (not null)
            if (Type == null)
            {
                throw new InvalidDataException("Type is a required property for Gateway and cannot be null");
            }
            else
            {
                this.Type = Type;
