...
namespace ProcessMaker.PMIO.Model
{
    ...
    public partial class ModelClient :  IEquatable<ModelClient>
    {
        ...
        /// <param name="Type">Type (required) (default to &quot;client&quot;).</param>
        /// <param name="Attributes">Attributes.</param>
        public ModelClient(int? Id = null, string Type = null, ClientAttributes Attributes = null)
        {
            // to ensure "Type" is required (not null)
            if (Type == null)
            {
                throw new InvalidDataException("Type is a required property for ModelClient and cannot be null");
            }
            else
            {
                this.Type = Type;
