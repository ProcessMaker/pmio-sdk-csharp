...
namespace ProcessMaker.PMIO.Model
{
    ...
    public partial class Flow :  IEquatable<Flow>
    {
        ...
        /// <param name="Type">Type (required) (default to &quot;flow&quot;).</param>
        /// <param name="Attributes">Attributes.</param>
        public Flow(string Id = null, string Type = null, FlowAttributes Attributes = null)
        {
            // to ensure "Type" is required (not null)
            if (Type == null)
            {
                throw new InvalidDataException("Type is a required property for Flow and cannot be null");
            }
            else
            {
                this.Type = Type;
        ...
        public FlowAttributes Attributes { get; set; }
        /// <summary>
